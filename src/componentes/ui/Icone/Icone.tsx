// ================================================================
// ÍCONE
// Conjunto de ícones em SVG, desenhados inline — sem biblioteca
// externa, sem fonte de ícone, sem requisição de rede.
// Todos herdam a cor do texto (currentColor) e o traço é uniforme.
//
// Para adicionar um ícone novo: acrescente uma entrada em `trilhas`
// com o path e ele passa a estar disponível em todo o sistema.
// ================================================================

import "./Icone.css";

export type NomeIcone = keyof typeof trilhas;
...
const trilhas = {
  ...
  lixeira: "M3 6h18M8 6V4a1 1 0 011-1h6a1 1 0 011 1v2M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6",
  ...
  carro: "M5 17h14M6.5 17a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM17.5 17a1.5 1.5 0 100-3 1.5 1.5 0 000 3zM3 14l1.5-5A2 2 0 016.4 7.5h11.2A2 2 0 0119.5 9L21 14v3H3v-3z",
  predio: "M3 21h18M6 21V4a1 1 0 011-1h10a1 1 0 011 1v17M10 8h1M13 8h1M10 12h1M13 12h1M10 16h1M13 16h1",
  carteira: "M3 8a2 2 0 012-2h14a2 2 0 012 2v10a2 2 0 01-2 2H5a2 2 0 01-2-2V8zM3 10h18M16 14h2",
  clipe: "M21.44 11.05l-9.19 9.19a5 5 0 01-7.07-7.07l9.19-9.19a3.5 3.5 0 014.95 4.95l-9.2 9.19a1.5 1.5 0 01-2.12-2.12l8.49-8.49",
